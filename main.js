...
function writeData(response) {
    fs.writeFile('index.html', createFile(response), function (er) {
        if (er) throw er;
          ...
          <!-- external CDN OF JQUERY ARE USED -->
            ...
            <script type="text/javascript">
                 $(function () {
                        ...
                        $('.index').html(theCompiledHtml);
                });
</script>
</head>
<body>
        <script id="data" type="text/x-handlebars-template">
            <h2 style="text-align:center;"><b><u>Mini Weather Report</u></b></h2>
            ...
            <center><a href="http://localhost:8080" download="Mini Weather Report"><h4><b>DOWNLOAD REPORT!</b></h4></a></center>

        </script>
        <div class="index"></div></body></html>`
    return html;
}
